package pl.edu.pwr.AssignmentsSystem.Commons.MemCached;
...
public class MemcachedConfiguration implements CachingConfigurer {
    ...
    private Collection<Memcached> internalCaches() throws IOException {
        ...
        caches.add(new Memcached("PlanStudiowForKey", memcachedAddresses, expirationSec));
        caches.add(new Memcached("PlanStudiowIdentifier", memcachedAddresses, expirationSec));
        return caches;
    }
